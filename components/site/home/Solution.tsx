...
export const Solution = () => {
  return (
    ...
    <DescHeader text="From scan to serve — QTend connects your guests and kitchen in a seamless,
digital flow." />


    <div className="grid grid-cols-4 gap-4 mt-16 max-w-desktop mx-auto">
        {
            solution.map(s => {
            ...
            return (
                ...
                className="bg-[#F7F7F7] border-t-2 rounded-2xl grid gap-6 py-12 px-4"
                >
                    <p 
                    ...
                    <div className="w-10 h-10 bg-[#FFFFFF] flex justify-center items-center border-[#E8E8E8] rounded-lg">
